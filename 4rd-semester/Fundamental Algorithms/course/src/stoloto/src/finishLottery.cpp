...
//             }
//             thVec.resize(0);
//             std::cout << "completed  " << i << " / " << numOfTickets / fileSize << std::endl;
//         }

//         thVec.push_back(new std::thread(FinishLotterey::Thfinish_7_49, path, static_cast<Sportloto_7_49*>(lot), std::ref(winV)));
//     }
